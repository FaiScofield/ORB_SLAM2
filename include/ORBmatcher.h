...
public:
    static const int TH_LOW;        // 匹配汉明距离的阈值，小一档，更严格
    static const int TH_HIGH;       // 匹配汉明距离的阈值，大一档，更宽松
    static const int HISTO_LENGTH;  // 角度值，统计匹配特征点的旋转主方向直方图用
...
protected:
    ...
    float mfNNratio;          // 最佳匹配比次佳匹配好的比例，越小越严格
    bool mbCheckOrientation;  // 特征点匹配时时候要根据旋转剔除误匹配，默认为1
};
